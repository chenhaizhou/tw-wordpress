<?php
/**
 * TW Theme functions and definitions
 * 
 * @package TW
 * @since 1.0
 */
...
function afford_sidebars() {
    ...
    register_sidebar(array(
        'name' => __('Nav Sidebar', 'afford'),
        'id' => 'nav_sidebar',
        'description' => __('Nav Sidebar', 'afford'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widget-title">',
        'after_title' => '</h4>',
...
function afford_enqueue() {
    ...
    wp_enqueue_script('masonry', AFFORD_GLOBAL_JS_URL . 'masonry.pkgd.min.js', array( 'jquery' ), '1.0.0', true);
